        ...
        <div className={styles.scrollWrapper}>
          <div ref={usPoliticsRef} className={styles.scrollContainer}>
            <div className={styles.cardLarge}>
              ...
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcReGtAGz-H036LEh-W9Tli4cC4NCIGmKLAvFg&s" alt="Man at White House" className={styles.imageLarge} />
              <div className={styles.details}>
              <h3 className={styles.cardTitle}>White House Tried to 'Lock Down' Ukraine Call Records, Whistle-blower Says</h3>
              <p className={styles.cardAuthor}>Eileen Sullivan</p>
              </div>
            </div>

            <div className={styles.cardLarge}>
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1EJOxo3MFnpjnWD1FB9ba7oHBPh1RZNEO6Q&s" alt="US Politics news" className={styles.imageLarge} />
              <div className={styles.details}>
            ...
            <div className={styles.cardLarge}>
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxBfcE9JXolswWVJV7qR4WWKKjz-MGafQvtg&s" alt="US Politics news" className={styles.imageLarge} />
              <div className={styles.details}>
...
export default NewYorkTimesHomepage;
